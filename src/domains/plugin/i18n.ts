export const translations = {
	...
	PLUGIN_INFO: {
		ABOUT: "About",
		DISCLAIMER:
			"The availability of this Plugin in the Solar Wallet does not mean that Solar is directly involved in its development or developers. By installing it, you assume any associated risks.",
